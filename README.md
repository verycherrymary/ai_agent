...
- основной ноутбук с исследованиями находится по ссылке (), эксперименты проводились на сайте Kaggle (предоставляется 30 часов в неделю для GPU,оперативная память 14гб) 
- файлы anwer_agent_qwen.csv, answer_agent_smol.csv - это сохраненные файлы с ответами агента на вопросы из тренировочной выборки (110 вопросов)
